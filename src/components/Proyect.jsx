            ...
            return (
              <div key={project.id} className='flex flex-col shadow-2xl bg-gray-900 rounded md:hover:scale-105 md:hover:bg-stone-900 duration-200'>
                ...
                <div className='px-8 py-10 flex flex-col gap-4'>
                  ...
                  <h4><span>Tecnologias usadas </span>{project.technologies}</h4>
                  <p className='text-slate-300'>{project.description}</p>
                  <div>
                    <LinkBtn classes={"bg-slate-200 text-black font-bold px-6 py-2 m-2 rounded hover:bg-gray-400 duration:200"}
                      linkText="Open"
